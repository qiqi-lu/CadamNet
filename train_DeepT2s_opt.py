...
# parser.add_argument('--model', default='DeepT2s', type=str, help='model name')
parser.add_argument('--model', default='DeepT2s(1)_100epoch', type=str, help='model name')
...
if __name__ == '__main__':
    ...
    data_valid = get_data_valid_patches(sigma_g=args.sigma)
